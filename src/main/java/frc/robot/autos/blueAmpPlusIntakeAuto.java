    ...
    public blueAmpPlusIntakeAuto(Swerve swerve, Shoulder shoulder, Wrist2 wrist2, Shooter2 shooter2, CollectorRoller collectorRoller, BeamBreakSensor beamBreakSensor){
        ...
        Trajectory firstPathTrajectory =
            TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(Units.feetToMeters(0), Units.feetToMeters(1.0), new Rotation2d(Units.degreesToRadians(270))),
                //Must change 'Y' value by at least 0.02 somewhere in the sequence
                List.of(
                     new Translation2d(Units.feetToMeters(1.0), Units.feetToMeters(1.05))
                    ),
                new Pose2d(Units.feetToMeters(2.0), Units.feetToMeters(1.0), new Rotation2d(Units.degreesToRadians(270))),
                config);
