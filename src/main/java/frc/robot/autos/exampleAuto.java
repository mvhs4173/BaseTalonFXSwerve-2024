    ...
    public exampleAuto(Swerve s_Swerve){
        ...
        Trajectory exampleTrajectory =
            TrajectoryGenerator.generateTrajectory(
                ...
                List.of(
                     new Translation2d(Units.feetToMeters(0.5), Units.feetToMeters(0.5))
                    ),
                // End 3 meters straight ahead of where we started, facing forward
                new Pose2d(Units.feetToMeters(1.0), Units.feetToMeters(1.0), new Rotation2d(Units.degreesToRadians(0))),
                config);
